...
import { buildEntityXml, extractIdsByTag, getIdFromXml, getText, parseXml } from '@/services/xml/xmlUtils'
...
export async function findCombinationIdByProductAndValueId(productId, valueId) {
	const combination = await findCombinationByProductAndValueId(productId, valueId)
	return combination ? combination.id : null
}
